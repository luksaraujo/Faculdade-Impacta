...
linha_investigada = int(input())            # Valor inteiro correspondente à linha a ser investigada
...
for i in range(12):                         # Laço responsável por somar os valores da coluna
    soma += matriz[linha_investigada][i]    # Soma os valores de cada coluna na linha indicada
